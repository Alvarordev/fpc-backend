...
export class AddEnrollmentsAndSymptomReports1784861000000 implements MigrationInterface {
  ...
  async up(q: QueryRunner): Promise<void> {
    ...
    await q.query(
      `CREATE TABLE "patient_symptom_reports" ("id" uuid PRIMARY KEY DEFAULT gen_random_uuid(), "patient_id" uuid NOT NULL REFERENCES "patients"("id"), "interaction_id" uuid NOT NULL REFERENCES "interactions"("id"), "enrollment_id" uuid REFERENCES "enrollments"("id"), "discomfort_severity" varchar(20), "discomfort_description" text, "symptom_duration_value_min" numeric(10,2), "symptom_duration_value_max" numeric(10,2), "symptom_duration_unit" varchar(10), "symptom_duration_label" varchar(120), "symptom_duration_canonical_minutes_min" integer, "symptom_duration_canonical_minutes_max" integer, "symptom_frequency_value_min" numeric(10,2), "symptom_frequency_value_max" numeric(10,2), "symptom_frequency_unit" varchar(10), "symptom_frequency_label" varchar(120), "symptom_frequency_canonical_minutes_min" integer, "symptom_frequency_canonical_minutes_max" integer, "is_pain_present" boolean, "pain_intensity" smallint CHECK ("pain_intensity" BETWEEN 0 AND 10), "pain_location" varchar(255), "pain_description" text, "has_sought_medical_consultation" boolean NOT NULL DEFAULT false, "health_center_id" uuid REFERENCES "health_centers"("id"), "specialty" varchar(255), "created_at" timestamptz NOT NULL DEFAULT now())`,
    );

...
export const CATALOG_ITEM_SEEDS: readonly CatalogItemSeed[] = [
  ...
  },
  {
    ...
    label: 'Ostomía',
    sortOrder: 20,
    metadata: { aliases: ['Ostomia'] },
  },
  {
    kind: 'surgical_procedure',
    code: 'EXTIRPACION_TUMOR',
    label: 'Extirpación de tumor',
    sortOrder: 30,
    metadata: { aliases: ['Extirpacion de tumor'] },
  },
  {
    kind: 'surgical_procedure',
    code: 'HISTERECTOMIA',
